...
__export(index_exports, {
  ...
  accessibilitySpecs: () => accessibilitySpecs,
  appleColors: () => appleColors,
  appleColorsDark: () => appleColorsDark,
  appleEasing: () => appleEasing,
  appleGlassSpecs: () => appleGlassSpecs,
  applePhysics: () => applePhysics,
  appleSpacing: () => appleSpacing,
  appleTypography: () => appleTypography,
  calculateLuminance: () => calculateLuminance,
  debounce: () => debounce,
  easeOutCubic: () => easeOutCubic,
  generateCSSCustomProperties: () => generateCSSCustomProperties,
